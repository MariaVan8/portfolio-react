...
function About() {
	const settings = {
		...
		responsive: [
			...
			{
				breakpoint: 960, // Desktop view
				settings: {
					slidesToShow: 2,
					centerPadding: "60px", // Adjust this to create the overlap effect
				},
			},
			{
				breakpoint: 1240, // Desktop view
				settings: {
					slidesToShow: 2,
			...
			{
				breakpoint: 1600, // Large desktop view
				settings: {
					slidesToShow: 2,
					centerPadding: "90px",
				},
				...
				<div className="about_container">
					...
					<section className="intro">
						<p>
							...
							meaningful contributions through my career in software
							development.
						</p>
						<p>
							I thrive on solving complex problems and continuously learning new
							skills. My commitment to excellence is reflected in my work ethic
							and my eagerness to take on new challenges.
						</p>
						<p>
							Outside of work, I find joy in nature and adventure. You'll often
							find me outdoors, geocaching, or exploring new trails. This love
							for exploration extends to my travels, where I immerse myself in
